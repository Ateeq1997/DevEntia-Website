...
const Hero = () => {
  return (
    <div className="relative bg-[#161616] h-[47rem] overflow-hidden">
      {/* Background image */}
      <Image
        src={heroBgImg}
        alt="people"
      ...
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[100%] max-w-[1800px] flex items-center justify-between px-2 z-[999]">
        {/* WhatsApp Icon */}
        <a
